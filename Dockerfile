...
LABEL summary="Provides the latest release of Red Hat Enterprise Linux 6 in a fully featured and supported base image."
...
LABEL io.k8s.display-name="Red Hat Enterprise Linux 6"
LABEL io.openshift.tags="base rhel6"
